...
<head>
    ...
    <title>Edit Announcement - {{ $announcement->title }} - NU Horizon LMS</title>
...
<div class="main-content" id="mainContent">
    <div class="top-bar">
        ...
        <div>
            <a href="{{ route('faculty.announcements', $announcement->course_id) }}" 
               ...
               style="text-decoration: none;">
                <i class="ri-arrow-left-line"></i> Back to Feed
            </a>
        </div>
    </div>
    ...
    <div class="p-4 md:p-6 max-w-3xl mx-auto">
        <div class="glass-card p-6">
            <div class="border-b border-gray-100 pb-4 mb-4">
                <h3 class="text-base font-extrabold m-0" style="color:var(--blue-deep);">Update Announcement Details</h3>
                <p class="text-xs text-gray-500 mt-1">Make changes to your published broadcast below.</p>
            </div>

            <form action="{{ route('faculty.announcement.update', $announcement->id) }}" method="POST" style="margin:0;">
                @csrf
                @method('PUT')
                
                <div class="mb-4">
                    <label class="block text-xs font-bold text-[#0A1F44] mb-2 uppercase tracking-wide">Announcement Title</label>
                ...
                <div class="flex justify-end gap-3">
                    <a href="{{ route('faculty.announcements', $announcement->course_id) }}" 
                       class="px-5 py-2.5 rounded-xl text-xs font-bold transition border border-slate-300 bg-white text-slate-600 hover:bg-slate-50"
                       style="text-decoration: none;">
                        Cancel
                    </a>
                    <button type="submit" 
                            class="flex items-center gap-1 px-6 py-2.5 rounded-xl text-xs font-black transition border-0 bg-[#0A1F44] text-white hover:bg-opacity-90 cursor-pointer shadow-sm">
