                        ...
                        <div class="bg-white rounded-lg shadow p-6">
                            ...
                            <div class="border-t mt-6 pt-6">
                                <div class="flex justify-between items-center mb-3">
                                    <span class="text-gray-600">Total Users Managed</span>
                                    <span class="font-semibold text-indigo-600">{{ $totalUsers }}</span>
                                </div>
                                <div class="flex justify-between items-center mb-3">
                                    <span class="text-gray-600">System Logins</span>
                                    <span class="font-semibold text-green-600">{{ $totalLogins }}</span>
                                </div>
                                <div class="flex justify-between items-center">
                                    <span class="text-gray-600">Actions Performed</span>
                                    <span class="font-semibold text-purple-600">{{ $totalActions }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="bg-white rounded-lg shadow mt-6">
                            ...
                            <div class="p-6">
                                        ...
                                        <div class="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                                            <div class="flex-shrink-0">
                                                @switch($activity->action)
                                                    @case('create')
                                                        <i class="ri-add-line text-green-600"></i>
                                                        @break
                                                    @case('update')
                                ...
                                <div class="mt-4 text-center">
                                    <a href="{{ route('admin.logs') }}" class="text-indigo-600 hover:text-indigo-800 text-sm">
                                        View All Activity →
                                    </a>
                                </div>
                            </div>
