...
<head>
    ...
    <title>Subject Management - Admin Panel | NU Clicks LMS</title>
...
<div class="main-content" id="mainContent">
    <div class="top-bar">
        ...
        <div>
            <h2 class="page-title text-lg md:text-xl">Subject Management</h2>
            <p class="text-sm text-gray-500 hidden md:block">Manage all subjects in the system</p>
        </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Subject Name</th>
                        ...
                        @empty
                            <tr>
                                <td colspan="10" class="px-6 py-12 text-center text-gray-500">
                                    ...
                                    No subjects found.
                                    <button onclick="openCreateModal()" class="ml-2 text-indigo-600 hover:text-indigo-800 font-medium">Create your first subject</button>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
    ...
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto mx-4">
        <div class="p-6 border-b border-gray-100 sticky top-0 bg-white z-10">
            <div class="flex justify-between items-start">
                <div>
                    <h3 class="text-xl font-bold text-gray-800" id="modalTitle">Create New Subject</h3>
                    <p class="text-gray-500 text-sm mt-1">Fill in the subject details below</p>
                </div>
        ...
        <div class="p-6">
            <form id="courseForm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Subject Code <span class="text-red-500">*</span></label>
                        <input type="text" id="code" name="code" required 
                               class="w-full border border-gray-300 rounded-xl px-4 py-2.5 focus:outline-none focus:border-gold transition"
                               placeholder="e.g., CS101">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Subject Name <span class="text-red-500">*</span></label>
                ...
                <div class="flex justify-end gap-3 pt-4 border-t border-gray-100">
                    ...
                    <button type="submit" class="px-6 py-2.5 rounded-xl transition shadow-sm" style="background: var(--blue-deep); color: white;">Save Subject</button>
                </div>
            </form>
        </div>
    </div>
