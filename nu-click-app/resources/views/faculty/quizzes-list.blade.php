    ...
    <div class="p-4 md:p-6">
        ...
        @else
            ...
            <div class="bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden text-center py-16 px-4 transition-all">
                ...
                <a href="{{ route('faculty.quiz.create') }}" class="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl text-sm font-bold transition shadow-md" style="background: var(--gold); color: var(--blue-deep);">
